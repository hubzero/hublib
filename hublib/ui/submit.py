...
class Submit(object):
    ...
    def __init__(self, 
        ...
        if cachename:
            ...
            def make_rname(*args):
                """
                Return hash of input(*args) generated by the joblib/Memory.cache decorator.
                  - cachedir and cachetabdir will use the same hash.
                The individual cachetabdir is:
                  - Submit.CACHETABDIR/cachename/joblib/hublib/ui/submit/make_rname/<hash>
                memory.cache generates a file: metadata.json in the above directory which 
                stores the inputs provided to this function.
                """
                return make_rname._get_argument_hash(*args)
